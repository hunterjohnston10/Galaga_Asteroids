...
PROGNAME = GalagaScroller

# The object files you want to compile into your program
# This should be a space (SPACE!) separated list of .o files
OFILES = main.o galagaalpha1.o mylib.o font.o game.o galagaplane.o bug.o moth.o stars.o galagaplane45.o galagaplane90.o galagaplane135.o galagaplane180.o galagaplanen45.o galagaplanen90.o galagaplanen135.o closingscreen.o

# The header files you have created.
# This is necessary to determine when to recompile for files.
# This should be a space (SPACE!) separated list of .h files
HFILES = mylib.h galagaalpha1.h galagaplane.h bug.h moth.h stars.h galagaplane45.h galagaplane90.h galagaplane135.h galagaplane180.h galagaplanen45.h galagaplanen90.h galagaplanen135.h closingscreen.h
